#ifndef _ATFS_INTERNAL_H
#define _ATFS_INTERNAL_H
...
#define BPLUSTREE_START 24     // blpustable
#define FREE_SPACE_START 28    // free space

#define NVM_MMAP_SIZE (1ULL << 34) /* 16GB */
#define ATFS_PAGE_SIZE (PAGE_SIZE + sizeof(list_node_t))
#define NVM_FREE_NUM_PAGES \
  ((NVM_MMAP_SIZE - FREE_SPACE_START * PAGE_SIZE) / (ATFS_PAGE_SIZE))
...
/* bplustree */
#define BPLUSTREE_LEVEL 3
#define BPLUSTREE_IDX_MASK (PTRS_PER_NODE - 1)

#define BPLUSTREE_NODE_PER_ALLOC 1
#define BPLUSTREE_NODE_PER_PAGE (PAGE_SIZE / sizeof(bplustree_node_t))
/* bpustree */

/* inode */
#define INODE_FAILED -1

#define ATFS_INODE_PER_ALLOC 1
#define ATFS_INODE_PER_PAGE (PAGE_SIZE / sizeof(struct unvmfs_inode))
/* inode */
...
void *get_bplustree_list_base_addr(void);
void *get_free_space_base_addr(void);
void *get_local_page_list_addr(u64 num);
void *get_bplustree_table_addr(u64 num);
